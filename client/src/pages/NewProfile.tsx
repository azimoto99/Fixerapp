...
// Removed StripeConnectSetup import
              ...
              <TabsContent value="payments">
                <div className="space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      {/* Temporarily replaced StripeConnectSetup with a placeholder */}
                      <div className="p-4 text-center">
                        <p className="text-gray-500 mb-4">
                          Stripe Connect integration is temporarily unavailable.
                        </p>
                        <p className="text-sm text-gray-400">
                          We're working on improving the payment processing experience.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <TabsContent value="badges">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Badges you've earned through your work</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {!userBadges || userBadges.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400">
                          Complete more jobs and receive good reviews to earn badges.
                        </p>
                      </div>
                    ) : (
