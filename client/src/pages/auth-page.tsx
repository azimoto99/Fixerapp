        ...
        <div className="max-w-md">
          ...
          <p className="text-xl mb-8">
            {accountType === 'enterprise' 
              ...
              : 'Connect skilled workers with local opportunities. Users coordinate payments directly.'}
          </p>
              ...
              <>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">Connect directly with clients and workers to coordinate payments and project details</p>
                  </div>
                </div>
              </>
            )}
